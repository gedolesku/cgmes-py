...
if TYPE_CHECKING:          from ENTSOE.CommonGridModelExchangeStandard.DynamicsProfile.UserDefinedModels.ProprietaryParameterDynamics import ProprietaryParameterDynamics     
