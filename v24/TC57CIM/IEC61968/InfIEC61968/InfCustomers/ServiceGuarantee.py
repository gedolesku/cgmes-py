...
# 
# ServiceGuarantee.py
# Python implementation of the Class ServiceGuarantee
...
class ServiceGuarantee(Document):
    ...
    activated, the customer can claim $25.
      2) If a customer has a question about their electricity bill, the utility
    will investigate and respond to the inquiry within 15 working days. If utility
    ...
    # payment.
    automaticPay: Boolean  = None
 
    # Period in which this service guantee applies.
    applicationPeriod: DateTimeInterval  = None
