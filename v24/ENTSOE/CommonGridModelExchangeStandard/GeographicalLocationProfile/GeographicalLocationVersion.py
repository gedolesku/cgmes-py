...
class GeographicalLocationVersion:
    ...
    # based on.
    baseURI: str  = "http://entsoe.eu/Secretariat/2013/Geographical/2"
    ...
    # URI (http://entsoe.eu/CIM/GeographicalLocation/yy/zzz) indicate major and minor
    # versions where:
    # - yy - indicates a major version;
    # - zzz - indicates a minor version. 
    entsoeURI: str  = "http://entsoe.eu/CIM/GeographicalLocation/2/1"
