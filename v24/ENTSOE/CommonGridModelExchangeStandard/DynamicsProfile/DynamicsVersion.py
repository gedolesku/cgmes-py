...
class DynamicsVersion:
    ...
    # based on.
    baseURI: str  = "http://iec.ch/TC57/2013/61970-457/Dynamics/3"
    ...
    # URI (http://entsoe.eu/CIM/Dynamics/yy/zzz) indicate major and minor versions
    # where:
    # - yy - indicates a major version;
    # - zzz - indicates a minor version. 
    entsoeURI: str  = "http://entsoe.eu/CIM/Dynamics/3/1"
