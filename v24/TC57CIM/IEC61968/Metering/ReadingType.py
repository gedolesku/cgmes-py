...
# 
# ReadingType.py
# Python implementation of the Class ReadingType
...
from TC57CIM.IEC61968.Metering.ReadingInterharmonic import ReadingInterharmonic
from TC57CIM.IEC61968.Metering.RationalNumber import RationalNumber
...
class ReadingType(IdentifiedObject):
    ...
    # and demand).
    flowDirection: String  = None
 
    # Commodity being measured.
    commodity: String  = None
    ...
    interharmonic: ReadingInterharmonic  = None
