...
class DiagramLayoutVersion:
    ...
    # based on.
    baseURI: str  = "http://iec.ch/TC57/2013/61970-453/DiagramLayout/3"
    ...
    # URI (http://entsoe.eu/CIM/DiagramLayout/yy/zzz) indicate major and minor
    # versions where:
    # - yy - indicates a major version;
    # - zzz - indicates a minor version. 
    entsoeURI: str  = "http://entsoe.eu/CIM/DiagramLayout/3/1"
