...
class TopologyBoundaryVersion:
    ...
    # based on.
    baseURI: str  = "http://iec.ch/TC57/2013/61970-456/TopologyBoundary/3"
    ...
    # URI (http://entsoe.eu/CIM/TopologyBoundary/yy/zzz) indicate major and minor
    # versions where:
    # - yy - indicates a major version;
    # - zzz - indicates a minor version. 
    entsoeURI: str  = "http://entsoe.eu/CIM/TopologyBoundary/3/1"
