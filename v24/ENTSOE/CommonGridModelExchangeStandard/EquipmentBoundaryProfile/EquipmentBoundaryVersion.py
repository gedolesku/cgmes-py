...
@dataclass
class EquipmentBoundaryVersion:
    ...
    # based on.
    baseURI: str  = "http://iec.ch/TC57/2013/61970-452/EquipmentBoundary/3"
    ...
    # URI (http://entsoe.eu/CIM/EquipmentBoundary/yy/zzz) indicate major and minor
    # versions where:
    # - yy - indicates a major version;
    # - zzz - indicates a minor version. 
    entsoeURIcore: str  = "http://entsoe.eu/CIM/EquipmentBoundary/3/1"
 
    # Profile URI defined by ENTSO-E and used in the Model Exchange header.  It
    # uniquely identifies the Profile and its version. The last two elements in the
    # URI (http://entsoe.eu/CIM/EquipmentBoundaryOperation/yy/zzz) indicate major and
    # minor versions where:
    # - yy - indicates a major version;
    # - zzz - indicates a minor version. 
    entsoeURIoperation: str  = "http://entsoe.eu/CIM/EquipmentBoundaryOperation/3/1"
