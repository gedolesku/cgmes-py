#######################################################
# 
# TopologyBoundaryVersion.py
# Python implementation of the Class TopologyBoundaryVersion
...
class TopologyBoundaryVersion:
    ...
    # based on.
    baseURI: String =  String.http://iec.ch/TC57/2013/61970-456/TopologyBoundary/3
    ...
    entsoeURI: String =  String.http://entsoe.eu/CIM/TopologyBoundary/3/1
