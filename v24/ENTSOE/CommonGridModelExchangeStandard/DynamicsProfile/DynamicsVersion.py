...
# 
# DynamicsVersion.py
# Python implementation of the Class DynamicsVersion
...
class DynamicsVersion:
    ...
    # based on.
    baseURI: String =  String.http://iec.ch/TC57/2013/61970-457/Dynamics/3
    ...
    entsoeURI: String =  String.http://entsoe.eu/CIM/Dynamics/3/1
