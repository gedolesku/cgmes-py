...
class EquipmentBoundaryVersion:
    ...
    # based on.
    baseURI_: str  = "http://iec.ch/TC57/2013/61970-452/EquipmentBoundary/3"
 
    # Profile creation date
    # Form is YYYY-MM-DD for example for January 5, 2009 it is 2009-01-05.
    date_: str  ="2014-06-09"
    ...
    entsoeURIcore_: str  = "http://entsoe.eu/CIM/EquipmentBoundary/3/1"
    ...
    # - yy - indicates a major version;
    # - zzz - indicates a minor version. 
    entsoeURIoperation_: str  = "http://entsoe.eu/CIM/EquipmentBoundaryOperation/3/1"
