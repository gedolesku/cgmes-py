#######################################################
# 
# GeographicalLocationVersion.py
# Python implementation of the Class GeographicalLocationVersion
...
class GeographicalLocationVersion:
    ...
    # based on.
    baseURI: String =  String.http://entsoe.eu/Secretariat/2013/Geographical/2
    ...
    entsoeURI: String =  String.http://entsoe.eu/CIM/GeographicalLocation/2/1
