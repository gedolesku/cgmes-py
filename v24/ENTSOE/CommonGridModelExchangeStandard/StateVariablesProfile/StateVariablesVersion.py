...
class StateVariablesVersion:
    ...
    # based on.
    baseURI: String =  String.http://iec.ch/TC57/2013/61970-456/StateVariables/4
    ...
    entsoeURI: String =  String.http://entsoe.eu/CIM/StateVariables/4/1
