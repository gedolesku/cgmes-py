...
# 
# PowerTransformer.py
# Python implementation of the Class PowerTransformer
...
from TC57CIM.IEC61970.Base.Wires.PowerTransformerEnd import PowerTransformerEnd
...
class PowerTransformer(ConductingEquipment):
    ...
    isPartOfGeneratorUnit: Boolean  = None
    ...
    # circuit data exchange according to IEC 60909.
    operationalValuesConsidered: Boolean  = None
