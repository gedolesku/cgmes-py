...
# 
# Shift.py
# Python implementation of the Class Shift
...
class Shift(IdentifiedObject):
    ...
    activityInterval: DateTimeInterval  = None
    ...
    receiptsGrandTotalBankable: Money  = None
    ...
    receiptsGrandTotalNonBankable: Money  = None
    ...
    receiptsGrandTotalRounding: Money  = None
