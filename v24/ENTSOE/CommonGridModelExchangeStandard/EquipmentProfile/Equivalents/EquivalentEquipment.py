...
from ENTSOE.CommonGridModelExchangeStandard.EquipmentProfile.Equivalents.EquivalentNetwork import EquivalentNetwork
...
class EquivalentEquipment(ConductingEquipment):
    ...
    EquivalentNetwork: Optional[EquivalentNetwork] = None
