...
class TransformerObservation(IdentifiedObject):
    ...
    waterContent: String  = None
 
    # Oil Quality Analysis-Color.
    oilColor: String  = None
    ...
    oilNeutralizationNumber: String  = None
    ...
    pumpVibration: String  = None
 
    # The level of oil in the transformer.
    oilLevel: String  = None
