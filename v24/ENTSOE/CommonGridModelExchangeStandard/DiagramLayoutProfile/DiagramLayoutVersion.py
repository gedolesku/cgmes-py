#######################################################
# 
# DiagramLayoutVersion.py
# Python implementation of the Class DiagramLayoutVersion
...
class DiagramLayoutVersion:
    ...
    # based on.
    baseURI: String =  String.http://iec.ch/TC57/2013/61970-453/DiagramLayout/3
    ...
    entsoeURI: String =  String.http://entsoe.eu/CIM/DiagramLayout/3/1
